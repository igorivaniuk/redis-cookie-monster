...
CookieMonster.prototype.removeAllCookies = function removeAllCookies(cb) {
    this.idx = {};
    this.saveToRepository(this.id, {}, function() {
        cb && cb(null);
    });
};
CookieMonster.prototype.getAllCookies = function getAllCookies() {
  return this.idx;
};
